		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Listado de ordenes de venta",
									"targetURL": "#nssaleorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nssaleorders-display": {
								"semanticObject": "nssaleorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.saleorders",
									"url": sap.ui.require.toUrl("ns/saleorders")
								}
							}
						}
					}
